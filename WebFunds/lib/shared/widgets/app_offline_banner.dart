...
/// The "Offline" async state. Renders nothing while online or while
/// connectivity is still resolving, so it is always safe to include.
class AppOfflineBanner extends ConsumerWidget {
  const AppOfflineBanner({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final isOnline = ref.watch(connectivityStatusProvider).value;
