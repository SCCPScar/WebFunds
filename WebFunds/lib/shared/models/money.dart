/// A monetary value — stored as minor units (cents) internally, never as
/// `double`. Every feature that touches an amount uses this instead of
/// `double`.
class Money implements Comparable<Money> {
  const Money._(this.minorUnits, this.currency);

  /// e.g. `128432` = €1,284.32. Never expose this as a raw `double`.
