...
/// Real implementation of [AuthRepository], backed by `SupabaseService`.
/// Written for the real flow even though no Supabase project exists yet
/// — the moment `env/development.json` is filled in, this starts working
/// with no code change, only a config change.
