...
class GenerateRecommendationsUseCase extends UseCase<List<WeaverRecommendation>, NoParams> {
  ...
  @override
  Future<Result<List<WeaverRecommendation>>> call(NoParams params) async {
    ...
    return Success(
      _engine.generateRecommendations(
        accounts: accounts,
        balances: balances,
